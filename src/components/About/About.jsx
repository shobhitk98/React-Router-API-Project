          ...
          <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
              <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                  ...
                  <div className="md:7/12 lg:w-6/12">
                      ...
                      React Router is a JavaScript framework that allows for client and server-side routing in React applications. It's used to create single-page web or mobile apps that can navigate between pages without refreshing the page. 
                      </p>
                  </div>
              </div>
          </div>
